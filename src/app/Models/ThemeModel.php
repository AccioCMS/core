...
class ThemeModel extends Model{
    ...
    protected static function boot(){
        ...
        self::saving(function($theme){
            Event::fire('theme:saving', [$theme]);
        });

        self::saved(function($theme){
            Event::fire('theme:saved', [$theme]);
        });

        self::updating(function($theme){
            Event::fire('theme:updating', [$theme]);
        });

        self::creating(function($theme){
        ...
        self::updated(function($theme){
            Event::fire('theme:updated', [$theme]);
        });

        self::deleting(function($theme){
            Event::fire('theme:deleting', [$theme]);
        });

        self::deleted(function($theme){
