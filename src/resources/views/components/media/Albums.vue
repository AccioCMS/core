    ...
    <div id="popupContent" class="popupContentLibrary" dusk="popupContentLibrary">
        <div class="imageWrapperPopupMedia" id="dropzone">
            <div class="imageContainerPopupMedia">
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 albumsHeader" id="filterSidebarMediaPopup">
                ...
                <div class="col-lg-9 col-md-7 col-sm-4 col-xs-12" id="filesMediaPopup">
                    ...
                    <div v-if="!isLoading && !Object.keys(getList).length">
                        {{trans.__noResults}}
                    </div>

                    <spinner :width="'30px'" :height="'30px'" :border="'5px'" v-if="isLoading"></spinner>

                    <article class="col-lg-3 col-md-4 col-sm-6 col-xs-12 albumWrapper" v-for="(album, index) in getList" v-if="!isLoading && Object.keys(getList).length">
                ...
                <div id="editPanel" class="col-lg-3 col-md-5 col-sm-8 col-xs-12" v-show="is_active">
