        ...
        <div class="imageWrapperPopupMedia" id="dropzone">
            <div class="imageContainerPopupMedia">
                ...
                <div class="col-lg-8 col-md-7 col-sm-6 col-xs-6" id="filesMediaPopup2">
                    ...
                    <div v-if="!spinner" :class="{'imageWrapper':true, 'active': isFileSelected(image.mediaID)}" v-for="(image, index) in getMediaList" @click="selectFile" :id="image.mediaID" :data-index="index">
